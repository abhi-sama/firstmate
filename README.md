...
- [docs/harness-busy-signatures.md](docs/harness-busy-signatures.md) - how each harness's busy-pane signature was measured and how to re-measure it when a harness update moves it.
